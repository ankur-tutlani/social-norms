...
def simulation_function_neighbors3(random_seed,
                                 iteration_name,
                                 path_to_save_output,
                                 num_strategies,
                                 agent_initial_state,
    ...
    random.seed(random_seed)
    Ginitial = nx.erdos_renyi_graph(n=m1_list,p=prob_1,seed=graphseed)
    G = nx.barabasi_albert_graph(n=num_agents, m=m2_list, seed=graphseed, initial_graph=Ginitial)
    ...
    parameters_pd = pd.DataFrame([{'random_seed':random_seed,'iteration_name':iteration_name,
                              ...
                              'function_to_use':function_to_use,'perturb_ratio':perturb_ratio,
                                   ...
                                   'graphseed':graphseed,
                                   'm1_list':m1_list,'m2_list':m2_list,
                              'datetime':today}]).T
